...
const routes = [
  ...
  { path: '/blog/how-to-flatten-pdf-online-free', title: 'How to Flatten a PDF Online for Free (No Upload Required) — 2026 Guide | Tiny PDF Tools', desc: 'Merge form fields, annotations, and layers into a static PDF. One click, no uploads, 100% in your browser.', priority: '0.7', freq: 'monthly' },
];
